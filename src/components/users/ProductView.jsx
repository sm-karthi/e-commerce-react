...
function ProductView() {
    ...
    return (
        <div className='p-6 flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-12 justify-center mt-10 md:mt-20'>

            <div className='border border-gray-200 rounded-md shadow-xl md:shadow-lg p-3 bg-white md:w-88 w-full h-fit'>
